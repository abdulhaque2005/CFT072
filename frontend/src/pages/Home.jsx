...
const farmingStyles = [
  ...
  { title: 'Water-Efficient Farming', img: 'https://images.unsplash.com/photo-1464226184884-fa280b87c399?w=600&q=80', desc: 'Drip irrigation se 40% pani bachao', tag: '💧 Eco-Friendly', link: '/fertilizer' },
...
const smartTips = [
  ...
  { icon: '☁️', title: 'Weather Alerts', desc: 'Mausam badalne se pehle alert lo — crop damage se bachao.', color: 'from-purple-50 to-violet-100', border: 'border-purple-200' },
  { icon: '🧪', title: 'Soil Testing', desc: 'Har 2-3 saal mein mitti check karwao — sahi fertilizer plan banao.', color: 'from-amber-50 to-yellow-100', border: 'border-amber-200' },
  { icon: '💰', title: 'PM Kisan Yojana', desc: '₹6,000/saal seedha account mein — abhi apply karo online.', color: 'from-rose-50 to-pink-100', border: 'border-rose-200' },
...
const rotatingTips = [
  ...
  { icon: '📱', tip: 'Daily weather alert ke liye app use karo' },
  { icon: '🧪', tip: 'Har 3 saal mein mitti ki jaanch zaroor karo' },
      ...
      <section className="py-4 bg-[#f4f7f4]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-5 -mt-20 relative z-20">
            {stats.map((s, i) => (
              <div key={i} className="bg-white/95 backdrop-blur-xl border border-green-100 shadow-[0_8px_30px_rgb(0,0,0,0.08)] rounded-2xl p-6 text-center hover:-translate-y-2 transition-transform duration-300 group">
                <div className="flex justify-center mb-2 text-green-600 group-hover:scale-125 transition-transform">{s.icon}</div>
                <div className="text-4xl font-black bg-gradient-to-r from-green-800 to-emerald-600 bg-clip-text text-transparent">{s.value}</div>
                <div className="text-xs text-gray-500 mt-1.5 font-bold uppercase tracking-widest">{s.label}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 bg-[#f4f7f4]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-3">🚜 Apna Farming Style Chunein</h2>
            <p className="text-gray-500 max-w-xl mx-auto font-medium">Har kisan ke liye alag approach — AI se guided</p>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-3">📅 Season Ke Hisaab Se Fasalein</h2>
            <p className="text-gray-500 max-w-xl mx-auto font-medium">Sahi season mein sahi fasal — AI guaranteed</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {seasons.map((s, i) => (
              <div key={i} className="bg-white rounded-3xl overflow-hidden shadow-sm border border-gray-100 hover:shadow-xl hover:border-green-200 transition-all hover:-translate-y-1 group">
                ...
                <div className="p-6">
                  <p className="text-xs text-gray-400 font-bold uppercase tracking-widest mb-3">Top Crops</p>
      ...
      <section className="py-16 bg-[#f4f7f4]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 font-medium">Ye tips apnao, yield aur income dono badhao</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {smartTips.map((tip, i) => (
              <div key={i} className={`bg-gradient-to-br ${tip.color} border ${tip.border} rounded-3xl p-6 hover:shadow-lg transition-all hover:-translate-y-1 group`}>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            ...
            <p className="text-gray-500 max-w-xl mx-auto font-medium text-lg">{city} mein farming ke liye AI-powered tools</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((f, i) => (
              <Link key={i} to={f.path} className={`relative bg-gradient-to-br ${f.bg} rounded-3xl p-6 shadow-sm border border-gray-100 hover:border-green-300 hover:shadow-xl transition-all duration-300 group flex flex-col hover:-translate-y-1 overflow-hidden`}>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 font-medium">Humare users ki asli kahaniyaan</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div key={i} className="bg-[#f4f7f4] rounded-3xl p-6 border border-gray-100 hover:shadow-xl hover:border-green-200 transition-all hover:-translate-y-1">
                ...
                <div className="flex items-center gap-3 pt-4 border-t border-gray-200">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-400 font-medium">{t.crop} · {t.loc}</p>
                  </div>
                </div>
              </div>
            ))}
          ...
          <div className="bg-gradient-to-br from-green-900 via-emerald-800 to-[#0a2e0d] rounded-[3rem] p-10 md:p-20 text-center shadow-2xl relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-2xl mx-auto">
              <h2 className="text-3xl md:text-5xl font-black text-white mb-6 leading-tight">
                Mitti Test Karo, <br />Fasal Badhao <Sparkles className="inline w-8 h-8 text-yellow-400 mb-2" />
              </h2>
              <p className="text-green-100/90 mb-10 text-lg font-medium">
                Bas apni mitti ka basic data daalein aur AI complete farming plan de dega. Bilkul free.
              </p>
              <Link to="/soil-input" className="inline-flex items-center gap-3 bg-white text-green-950 px-10 py-5 rounded-2xl font-black text-lg hover:shadow-[0_0_30px_rgba(255,255,255,0.3)] hover:bg-gray-50 transition-all active:scale-95 hover:-translate-y-1">
                <FlaskConical className="w-6 h-6" /> Soil Analysis Shuru Karo
              </Link>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-start justify-between gap-8">
            <div>
              ...
              <p className="text-gray-400 text-sm max-w-xs font-medium leading-relaxed">India ke kisaanon ke liye AI se powered smart farming platform.</p>
            </div>

...
export default function KisaanAIAssistant() {
  ...
  // Convert URLs or basic markdown to readable text visually
            ...
            <div className="flex items-center gap-2 bg-gray-50 border border-gray-200 rounded-full p-1 pl-4 pr-1 focus-within:border-primary-400 focus-within:ring-2 focus-within:ring-primary-100 transition-all">
              ...
              <button
                ...
                className={`w-10 h-10 rounded-full flex flex-shrink-0 items-center justify-center transition-all ${
                  listening ? 'bg-red-500 text-white animate-pulse shadow-md shadow-red-500/40' : 'bg-gray-200 text-gray-600 hover:bg-gray-300'
                }`}
              >
              ...
              <button
                ...
                className={`w-10 h-10 rounded-full flex flex-shrink-0 items-center justify-center transition-all ${
                  inputText.trim() && !loading ? 'bg-primary-600 text-white shadow-md hover:bg-primary-700' : 'bg-gray-100 text-gray-400'
                }`}
              >
